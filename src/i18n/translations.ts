...
const en: Dict = {
  ...
  'common.round': 'Round',
  'common.round_complete': 'Round complete',
  'common.quiz_complete': 'Quiz complete',
  'common.game_over': 'Game over',
  'common.cleared': 'Cleared!',
  'common.solved': 'Solved!',
  'common.crashed': 'Crashed!',
  'common.time_up': "Time's up!",
  'common.your_turn': 'Your turn',
  'common.bot_turn': "Bot's turn",
  'common.try_again': 'Try again',
  'common.play_again': 'Play again',
  'common.new_round': 'New round',
  'common.new_game': 'New game',
  'common.new_puzzle': 'New puzzle',
  'common.new_deal': 'New deal',
  'common.new_deck': 'New deck',
  'common.new_quiz': 'New quiz',
  'common.new_maze': 'New maze',
  'common.new_board': 'New board',
  'common.new_run': 'Run again',
  'common.shuffle_again': 'Shuffle again',
  'common.next_puzzle': 'Next puzzle',
  'common.roll_dice': 'Roll Dice',
  'common.choose_color': 'Choose a Color',
  'common.choose_suit': 'Choose a suit',
  'common.bank': 'Bank',
  'common.best': 'Best',
  'common.final': 'Final',
  ...
  'common.stock': 'Stock',
  'common.sum': 'Sum',
  'common.tiles_remaining': 'Tiles remaining',
  'common.column': 'Column',
  'common.no_tiles_played': 'No tiles played yet.',
  'common.deck_empty': 'Deck empty.',
  'common.start': 'Start',
  'common.stop': 'Stop',
  ...
  'common.next': 'Next',
  'common.found': 'Found',
  'common.all_found': 'All found',
  'common.solved_in_moves': 'Solved in {moves} moves!',
  'common.move_count': '{count} moves',
  'common.q_of_n': 'Question {n}/{total}',
  'common.score_value': 'Score {n}',
  'common.time_seconds': '{n}s',
  'common.try_again_subtitle': 'Try again?',
  'common.cleared_subtitle': 'Great work!',
  'common.perfect_score': 'Perfect score!',
  'common.win_pieces_borne_off': 'All pieces borne off.',
  'common.win_first_to_100': 'First to 100 takes the crown.',
  'common.win_all_pairs': 'All pairs matched!',
  'common.win_all_dots_linked': 'All dots linked.',
  'common.win_all_tiles': 'Every tile matched!',
  'common.win_all_tokens_home': 'All four tokens home.',
  'common.win_no_pieces_fit': 'No more pieces fit.',
  'common.win_captured_deck': 'Captured the whole deck.',
  'common.win_clean_hand': 'Cleaned out the hand.',
  'common.win_great_logic': 'Great logic work.',
  'common.win_try_another_scene': 'Try another scene!',
  'common.no_more_moves': 'No more moves',
  'common.you_win': 'You win!',
...
const it: Dict = {
  ...
  'common.round': 'Giocata',
  'common.round_complete': 'Giocata completata',
  'common.quiz_complete': 'Quiz completato',
  'common.game_over': 'Fine partita',
  'common.cleared': 'Completato!',
  'common.solved': 'Risolto!',
  'common.crashed': 'Schianto!',
  'common.time_up': 'Tempo scaduto!',
  'common.your_turn': 'Tocca a te',
  'common.bot_turn': 'Turno del bot',
  'common.try_again': 'Riprova',
  'common.play_again': 'Gioca ancora',
  'common.new_round': 'Nuova giocata',
  'common.new_game': 'Nuova partita',
  'common.new_puzzle': 'Nuovo puzzle',
  'common.new_deal': 'Nuova mano',
  'common.new_deck': 'Nuovo mazzo',
  'common.new_quiz': 'Nuovo quiz',
  'common.new_maze': 'Nuovo labirinto',
  'common.new_board': 'Nuovo tabellone',
  'common.new_run': 'Corri ancora',
  'common.shuffle_again': 'Mescola ancora',
  'common.next_puzzle': 'Puzzle successivo',
  'common.roll_dice': 'Lancia i dadi',
  'common.choose_color': 'Scegli un colore',
  'common.choose_suit': 'Scegli un seme',
  'common.bank': 'Banca',
  'common.best': 'Record',
  'common.final': 'Finale',
  'common.streak': 'Combo',
  'common.stock': 'Mazzo',
  'common.sum': 'Somma',
  'common.tiles_remaining': 'Tessere rimaste',
  'common.column': 'Colonna',
  'common.no_tiles_played': 'Nessuna tessera giocata.',
  'common.deck_empty': 'Mazzo vuoto.',
  'common.start': 'Avvia',
  'common.stop': 'Ferma',
  ...
  'common.all_found': 'Trovati tutti',
  'common.solved_in_moves': 'Risolto in {moves} mosse!',
  'common.move_count': '{count} mosse',
  'common.q_of_n': 'Domanda {n}/{total}',
  'common.score_value': 'Punteggio {n}',
  'common.time_seconds': '{n}s',
  'common.try_again_subtitle': 'Riprovare?',
  'common.cleared_subtitle': 'Ottimo lavoro!',
  'common.perfect_score': 'Punteggio perfetto!',
  'common.win_pieces_borne_off': 'Tutti i pezzi a casa.',
  'common.win_first_to_100': 'Primo a 100 vince la corona.',
  'common.win_all_pairs': 'Tutte le coppie trovate!',
  'common.win_all_dots_linked': 'Tutti i punti collegati.',
  'common.win_all_tiles': 'Ogni tessera abbinata!',
  'common.win_all_tokens_home': 'Tutte e quattro le pedine a casa.',
  'common.win_no_pieces_fit': 'Nessun pezzo entra più.',
  'common.win_captured_deck': 'Conquistato tutto il mazzo.',
  'common.win_clean_hand': 'Mano svuotata.',
  'common.win_great_logic': 'Bel lavoro logico.',
  'common.win_try_another_scene': 'Prova un’altra scena!',
  'common.no_more_moves': 'Niente più mosse',
  'common.you_win': 'Hai vinto!',
  'common.you_lose': 'Hai perso',
  'common.tie': 'Pareggio',
...
const de: Dict = {
  ...
  'common.round': 'Runde',
  'common.round_complete': 'Runde beendet',
  'common.quiz_complete': 'Quiz beendet',
  'common.game_over': 'Spielende',
  'common.cleared': 'Geschafft!',
  'common.solved': 'Gelöst!',
  'common.crashed': 'Abgestürzt!',
  'common.time_up': 'Zeit ist um!',
  'common.your_turn': 'Du bist dran',
  'common.bot_turn': 'Bot ist dran',
  'common.try_again': 'Nochmal',
  'common.play_again': 'Nochmal spielen',
  'common.new_round': 'Neue Runde',
  'common.new_game': 'Neues Spiel',
  'common.new_puzzle': 'Neues Rätsel',
  'common.new_deal': 'Neue Runde',
  'common.new_deck': 'Neues Deck',
  'common.new_quiz': 'Neues Quiz',
  'common.new_maze': 'Neues Labyrinth',
  'common.new_board': 'Neues Brett',
  'common.new_run': 'Nochmal laufen',
  'common.shuffle_again': 'Nochmal mischen',
  'common.next_puzzle': 'Nächstes Rätsel',
  'common.roll_dice': 'Würfeln',
  'common.choose_color': 'Farbe wählen',
  'common.choose_suit': 'Farbe wählen',
  'common.bank': 'Bank',
  'common.best': 'Bestleistung',
  'common.final': 'Endstand',
  'common.streak': 'Serie',
  'common.stock': 'Stapel',
  'common.sum': 'Summe',
  'common.tiles_remaining': 'Verbleibende Steine',
  'common.column': 'Spalte',
  'common.no_tiles_played': 'Noch keine Steine gelegt.',
  'common.deck_empty': 'Deck leer.',
  'common.start': 'Start',
  'common.stop': 'Stopp',
  ...
  'common.all_found': 'Alle gefunden',
  'common.solved_in_moves': 'Gelöst in {moves} Zügen!',
  'common.move_count': '{count} Züge',
  'common.q_of_n': 'Frage {n}/{total}',
  'common.score_value': 'Punkte {n}',
  'common.time_seconds': '{n}s',
  'common.try_again_subtitle': 'Nochmal versuchen?',
  'common.cleared_subtitle': 'Toll gemacht!',
  'common.perfect_score': 'Perfekt!',
  'common.win_pieces_borne_off': 'Alle Steine im Ziel.',
  'common.win_first_to_100': 'Erster auf 100 trägt die Krone.',
  'common.win_all_pairs': 'Alle Paare gefunden!',
  'common.win_all_dots_linked': 'Alle Punkte verbunden.',
  'common.win_all_tiles': 'Jeder Stein zugeordnet!',
  'common.win_all_tokens_home': 'Alle vier Spielsteine zu Hause.',
  'common.win_no_pieces_fit': 'Kein Teil passt mehr.',
  'common.win_captured_deck': 'Das ganze Deck erobert.',
  'common.win_clean_hand': 'Hand leer geräumt.',
  'common.win_great_logic': 'Tolle Logikarbeit.',
  'common.win_try_another_scene': 'Probier eine andere Szene!',
  'common.no_more_moves': 'Keine Züge mehr',
  'common.you_win': 'Du gewinnst!',
  'common.you_lose': 'Du verlierst',
